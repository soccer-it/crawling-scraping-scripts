...
(async () => {
	...
	console.log('Scraping Campeonato Paranaense 2019 - Primeira Fase!');
	...
	await page.goto('https://globoesporte.globo.com/pr/futebol/campeonato-paranaense/');

	const rootPath = './championships/paranaense-2019/first-phase';
